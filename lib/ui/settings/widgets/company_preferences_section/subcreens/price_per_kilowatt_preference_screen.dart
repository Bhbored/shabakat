...
class PricePerKilowattPreferenceScreen extends ConsumerStatefulWidget {
  const PricePerKilowattPreferenceScreen({super.key});

  @override
  ConsumerState<PricePerKilowattPreferenceScreen> createState() =>
      _PricePerKilowattPreferenceScreenState();
}

class _PricePerKilowattPreferenceScreenState
    extends ConsumerState<PricePerKilowattPreferenceScreen> {
  ...
  double _valueForTier(CompanyPreferences preferences, _CustomerTier tier) {
    return switch (tier) {
      _CustomerTier.base => preferences.pricePerKilowat,
      _CustomerTier.residential => preferences.residentialPricePerKilowat,
      _CustomerTier.commercial => preferences.commercialPricePerKilowat,
      _CustomerTier.industrial => preferences.industrialPricePerKilowat,
    };
  }
  ...
  CompanyPreferences _updateTierValue(
    ...
    return switch (tier) {
      _CustomerTier.base => preferences.copyWith(pricePerKilowat: value),
      _CustomerTier.residential => preferences.copyWith(
        residentialPricePerKilowat: value,
      ),
      _CustomerTier.commercial => preferences.copyWith(
        commercialPricePerKilowat: value,
      ),
      _CustomerTier.industrial => preferences.copyWith(
        industrialPricePerKilowat: value,
      ),
    };
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('settings.preferences.price_per_kilowatt'.tr()),
      ),
      body: Column(
        children: [
          Expanded(
            ...
            child: SizedBox(
              ...
              child: ElevatedButton(
                onPressed: isSaving
                    ...
                    ? () async {
                        _commitCurrentValue();
                        final kilowattDraft = _draft!;
                        if (kilowattDraft == _original) return;

                        final updated = current.copyWith(
                          pricePerKilowat: kilowattDraft.pricePerKilowat,
                          residentialPricePerKilowat:
                              kilowattDraft.residentialPricePerKilowat,
                          commercialPricePerKilowat:
                              kilowattDraft.commercialPricePerKilowat,
                          industrialPricePerKilowat:
                              kilowattDraft.industrialPricePerKilowat,
                        );
