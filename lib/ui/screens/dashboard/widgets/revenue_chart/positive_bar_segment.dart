...
class PositiveBarSegment extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final barHeight = maxPositive == 0
        ? 0.0
        : (bar.value / maxPositive) * drawableHeight;
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.vertical(
              top: Radius.circular(context.borderRadiusMedium * 0.35),
            ),
          ),
        ),
      ],
