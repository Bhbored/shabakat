...
@override
String toString() {
  return 'UpdatePreferencesRequest(pricePerKilowat: $pricePerKilowat, pricePerAmp: $pricePerAmp, fixedCharge: $fixedCharge, tva: $tva, language: $language, triggerDate: $triggerDate, triggerMessage: $triggerMessage)';
}
...
class _UpdatePreferencesRequest implements UpdatePreferencesRequest {
  const _UpdatePreferencesRequest({required this.pricePerKilowat, required this.pricePerAmp, required this.fixedCharge, required this.tva, required this.language, required this.triggerDate, this.triggerMessage});
