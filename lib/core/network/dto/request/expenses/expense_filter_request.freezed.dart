...
@JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson) DateTime? get dateFrom;@JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson) DateTime? get dateTo; ExpenseType? get expenseType; int get pageNumber; int get pageSize;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,dateFrom,dateTo,expenseType,pageNumber,pageSize);

@override
String toString() {
  return 'ExpenseFilterRequest(dateFrom: $dateFrom, dateTo: $dateTo, expenseType: $expenseType, pageNumber: $pageNumber, pageSize: $pageSize)';
}
...
@useResult
$Res call({
@JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson) DateTime? dateFrom,@JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson) DateTime? dateTo, ExpenseType? expenseType, int pageNumber, int pageSize
});
...
/// Create a copy of ExpenseFilterRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? dateFrom = freezed,Object? dateTo = freezed,Object? expenseType = freezed,Object? pageNumber = null,Object? pageSize = null,}) {
...
as DateTime?,expenseType: freezed == expenseType ? _self.expenseType : expenseType // ignore: cast_nullable_to_non_nullable
as ExpenseType?,pageNumber: null == pageNumber ? _self.pageNumber : pageNumber // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson)  DateTime? dateFrom, @JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson)  DateTime? dateTo,  ExpenseType? expenseType,  int pageNumber,  int pageSize)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ExpenseFilterRequest() when $default != null:
return $default(_that.dateFrom,_that.dateTo,_that.expenseType,_that.pageNumber,_that.pageSize);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson)  DateTime? dateFrom, @JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson)  DateTime? dateTo,  ExpenseType? expenseType,  int pageNumber,  int pageSize)  $default,) {final _that = this;
switch (_that) {
case _ExpenseFilterRequest():
return $default(_that.dateFrom,_that.dateTo,_that.expenseType,_that.pageNumber,_that.pageSize);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson)  DateTime? dateFrom, @JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson)  DateTime? dateTo,  ExpenseType? expenseType,  int pageNumber,  int pageSize)?  $default,) {final _that = this;
switch (_that) {
case _ExpenseFilterRequest() when $default != null:
return $default(_that.dateFrom,_that.dateTo,_that.expenseType,_that.pageNumber,_that.pageSize);case _:
  return null;
...
class _ExpenseFilterRequest implements ExpenseFilterRequest {
  const _ExpenseFilterRequest({@JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson) this.dateFrom, @JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson) this.dateTo, this.expenseType, this.pageNumber = 1, this.pageSize = 10});
...
/// Create a copy of ExpenseFilterRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? dateFrom = freezed,Object? dateTo = freezed,Object? expenseType = freezed,Object? pageNumber = null,Object? pageSize = null,}) {
