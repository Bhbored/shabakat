...
@override
String toString() {
  return 'CreateAmpereScheduleRequest(name: $name, hoursPerDay: $hoursPerDay, pricePerAmp: $pricePerAmp, residentialPricePerAmp: $residentialPricePerAmp, commercialPricePerAmp: $commercialPricePerAmp, industrialPricePerAmp: $industrialPricePerAmp)';
}
...
class _CreateAmpereScheduleRequest implements CreateAmpereScheduleRequest {
  const _CreateAmpereScheduleRequest({required this.name, required this.hoursPerDay, this.pricePerAmp, this.residentialPricePerAmp, this.commercialPricePerAmp, this.industrialPricePerAmp});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CreateAmpereScheduleRequest&&(identical(other.name, name) || other.name == name)&&(identical(other.hoursPerDay, hoursPerDay) || other.hoursPerDay == hoursPerDay)&&(identical(other.pricePerAmp, pricePerAmp) || other.pricePerAmp == pricePerAmp)&&(identical(other.residentialPricePerAmp, residentialPricePerAmp) || other.residentialPricePerAmp == residentialPricePerAmp)&&(identical(other.commercialPricePerAmp, commercialPricePerAmp) || other.commercialPricePerAmp == commercialPricePerAmp)&&(identical(other.industrialPricePerAmp, industrialPricePerAmp) || other.industrialPricePerAmp == industrialPricePerAmp));
}
