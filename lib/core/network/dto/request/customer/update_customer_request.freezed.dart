...
@override
String toString() {
  return 'UpdateCustomerRequest(name: $name, phone: $phone, address: $address, areaId: $areaId, customerType: $customerType, plan: $plan, planValue: $planValue, customerStatus: $customerStatus, customerRelation: $customerRelation, pricingOverride: $pricingOverride, clearPricingOverride: $clearPricingOverride)';
}
...
class _UpdateCustomerRequest implements UpdateCustomerRequest {
  const _UpdateCustomerRequest({this.name, this.phone, this.address, this.areaId, this.customerType, this.plan, this.planValue, this.customerStatus, this.customerRelation, this.pricingOverride, this.clearPricingOverride = false});
