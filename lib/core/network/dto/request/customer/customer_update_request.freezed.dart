...
mixin _$CustomerUpdateRequest {
 ...
 String? get name; String? get phone; String? get address; CustomerType? get customerType; PlanType? get plan; double? get planValue; CustomerStatus? get customerStatus; CustomerRelation? get customerRelation; CustomerPricingOverrideDto? get pricingOverride; bool get clearPricingOverride;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,phone,address,customerType,plan,planValue,customerStatus,customerRelation,pricingOverride,clearPricingOverride);

@override
String toString() {
  return 'CustomerUpdateRequest(name: $name, phone: $phone, address: $address, customerType: $customerType, plan: $plan, planValue: $planValue, customerStatus: $customerStatus, customerRelation: $customerRelation, pricingOverride: $pricingOverride, clearPricingOverride: $clearPricingOverride)';
}
...
@useResult
$Res call({
 String? name, String? phone, String? address, CustomerType? customerType, PlanType? plan, double? planValue, CustomerStatus? customerStatus, CustomerRelation? customerRelation, CustomerPricingOverrideDto? pricingOverride, bool clearPricingOverride
});
...
switch (_that) {
case _CustomerUpdateRequest() when $default != null:
return $default(_that.name,_that.phone,_that.address,_that.customerType,_that.plan,_that.planValue,_that.customerStatus,_that.customerRelation,_that.pricingOverride,_that.clearPricingOverride);case _:
  return orElse();
...
switch (_that) {
case _CustomerUpdateRequest():
return $default(_that.name,_that.phone,_that.address,_that.customerType,_that.plan,_that.planValue,_that.customerStatus,_that.customerRelation,_that.pricingOverride,_that.clearPricingOverride);}
}
...
class _CustomerUpdateRequest implements CustomerUpdateRequest {
  const _CustomerUpdateRequest({this.name, this.phone, this.address, this.customerType, this.plan, this.planValue, this.customerStatus, this.customerRelation, this.pricingOverride, this.clearPricingOverride = false});
...
/// Create a copy of CustomerUpdateRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = freezed,Object? phone = freezed,Object? address = freezed,Object? customerType = freezed,Object? plan = freezed,Object? planValue = freezed,Object? customerStatus = freezed,Object? customerRelation = freezed,Object? pricingOverride = freezed,Object? clearPricingOverride = null,}) {
