...
mixin _$InvoiceResponse {
 ...
 String get id; int get invoiceNumber; String get customerName;@JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson) DateTime get consumptionStart;@JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson) DateTime get consumptionEnd; double get fixedCharge; double get tva; double get totalAmount; double get paidAmount; double get amountDue; double? get billedConsumption; String get invoiceStatus; DateTime get createdAt; DateTime get updatedAt; List<PaymentResponse> get payments;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,invoiceNumber,customerName,consumptionStart,consumptionEnd,fixedCharge,tva,totalAmount,paidAmount,amountDue,billedConsumption,invoiceStatus,createdAt,updatedAt,const DeepCollectionEquality().hash(payments));

@override
String toString() {
  return 'InvoiceResponse(id: $id, invoiceNumber: $invoiceNumber, customerName: $customerName, consumptionStart: $consumptionStart, consumptionEnd: $consumptionEnd, fixedCharge: $fixedCharge, tva: $tva, totalAmount: $totalAmount, paidAmount: $paidAmount, amountDue: $amountDue, billedConsumption: $billedConsumption, invoiceStatus: $invoiceStatus, createdAt: $createdAt, updatedAt: $updatedAt, payments: $payments)';
}
...
switch (_that) {
case _InvoiceResponse() when $default != null:
return $default(_that.id,_that.invoiceNumber,_that.customerName,_that.consumptionStart,_that.consumptionEnd,_that.fixedCharge,_that.tva,_that.totalAmount,_that.paidAmount,_that.amountDue,_that.billedConsumption,_that.invoiceStatus,_that.createdAt,_that.updatedAt,_that.payments);case _:
  return orElse();
...
switch (_that) {
case _InvoiceResponse():
return $default(_that.id,_that.invoiceNumber,_that.customerName,_that.consumptionStart,_that.consumptionEnd,_that.fixedCharge,_that.tva,_that.totalAmount,_that.paidAmount,_that.amountDue,_that.billedConsumption,_that.invoiceStatus,_that.createdAt,_that.updatedAt,_that.payments);}
}
...
class _InvoiceResponse implements InvoiceResponse {
  const _InvoiceResponse({required this.id, required this.invoiceNumber, required this.customerName, @JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson) required this.consumptionStart, @JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson) required this.consumptionEnd, required this.fixedCharge, required this.tva, required this.totalAmount, required this.paidAmount, required this.amountDue, this.billedConsumption, required this.invoiceStatus, required this.createdAt, required this.updatedAt, required final  List<PaymentResponse> payments}): _payments = payments;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,invoiceNumber,customerName,consumptionStart,consumptionEnd,fixedCharge,tva,totalAmount,paidAmount,amountDue,billedConsumption,invoiceStatus,createdAt,updatedAt,const DeepCollectionEquality().hash(_payments));
