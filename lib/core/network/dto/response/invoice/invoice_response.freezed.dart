...
mixin _$InvoiceResponse {
 ...
 String get id; int get invoiceNumber; String get customerId; String get customerName;@JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson) DateTime get issueDate;@JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson) DateTime get dueDate; double get fixedCharge; double get tva; double get totalAmount; double get paidAmount; double get amountDue; double? get billedConsumption; String get invoiceStatus; DateTime get createdAt; DateTime get updatedAt; List<PaymentResponse> get payments;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,invoiceNumber,customerId,customerName,issueDate,dueDate,fixedCharge,tva,totalAmount,paidAmount,amountDue,billedConsumption,invoiceStatus,createdAt,updatedAt,const DeepCollectionEquality().hash(payments));

@override
String toString() {
  return 'InvoiceResponse(id: $id, invoiceNumber: $invoiceNumber, customerId: $customerId, customerName: $customerName, issueDate: $issueDate, dueDate: $dueDate, fixedCharge: $fixedCharge, tva: $tva, totalAmount: $totalAmount, paidAmount: $paidAmount, amountDue: $amountDue, billedConsumption: $billedConsumption, invoiceStatus: $invoiceStatus, createdAt: $createdAt, updatedAt: $updatedAt, payments: $payments)';
}
...
/// Create a copy of InvoiceResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? invoiceNumber = null,Object? customerId = null,Object? customerName = null,Object? issueDate = null,Object? dueDate = null,Object? fixedCharge = null,Object? tva = null,Object? totalAmount = null,Object? paidAmount = null,Object? amountDue = null,Object? billedConsumption = freezed,Object? invoiceStatus = null,Object? createdAt = null,Object? updatedAt = null,Object? payments = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  int invoiceNumber,  String customerId,  String customerName, @JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson)  DateTime issueDate, @JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson)  DateTime dueDate,  double fixedCharge,  double tva,  double totalAmount,  double paidAmount,  double amountDue,  double? billedConsumption,  String invoiceStatus,  DateTime createdAt,  DateTime updatedAt,  List<PaymentResponse> payments)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _InvoiceResponse() when $default != null:
return $default(_that.id,_that.invoiceNumber,_that.customerId,_that.customerName,_that.issueDate,_that.dueDate,_that.fixedCharge,_that.tva,_that.totalAmount,_that.paidAmount,_that.amountDue,_that.billedConsumption,_that.invoiceStatus,_that.createdAt,_that.updatedAt,_that.payments);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  int invoiceNumber,  String customerId,  String customerName, @JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson)  DateTime issueDate, @JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson)  DateTime dueDate,  double fixedCharge,  double tva,  double totalAmount,  double paidAmount,  double amountDue,  double? billedConsumption,  String invoiceStatus,  DateTime createdAt,  DateTime updatedAt,  List<PaymentResponse> payments)  $default,) {final _that = this;
switch (_that) {
case _InvoiceResponse():
return $default(_that.id,_that.invoiceNumber,_that.customerId,_that.customerName,_that.issueDate,_that.dueDate,_that.fixedCharge,_that.tva,_that.totalAmount,_that.paidAmount,_that.amountDue,_that.billedConsumption,_that.invoiceStatus,_that.createdAt,_that.updatedAt,_that.payments);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  int invoiceNumber,  String customerId,  String customerName, @JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson)  DateTime issueDate, @JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson)  DateTime dueDate,  double fixedCharge,  double tva,  double totalAmount,  double paidAmount,  double amountDue,  double? billedConsumption,  String invoiceStatus,  DateTime createdAt,  DateTime updatedAt,  List<PaymentResponse> payments)?  $default,) {final _that = this;
switch (_that) {
case _InvoiceResponse() when $default != null:
return $default(_that.id,_that.invoiceNumber,_that.customerId,_that.customerName,_that.issueDate,_that.dueDate,_that.fixedCharge,_that.tva,_that.totalAmount,_that.paidAmount,_that.amountDue,_that.billedConsumption,_that.invoiceStatus,_that.createdAt,_that.updatedAt,_that.payments);case _:
  return null;
...
class _InvoiceResponse implements InvoiceResponse {
  const _InvoiceResponse({required this.id, required this.invoiceNumber, this.customerId = '', required this.customerName, @JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson) required this.issueDate, @JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson) required this.dueDate, required this.fixedCharge, required this.tva, required this.totalAmount, required this.paidAmount, required this.amountDue, this.billedConsumption, required this.invoiceStatus, required this.createdAt, required this.updatedAt, required final  List<PaymentResponse> payments}): _payments = payments;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,invoiceNumber,customerId,customerName,issueDate,dueDate,fixedCharge,tva,totalAmount,paidAmount,amountDue,billedConsumption,invoiceStatus,createdAt,updatedAt,const DeepCollectionEquality().hash(_payments));
