...
mixin _$InvoiceResponse {
 ...
 String get id; int get invoiceNumber; String get customerName;@JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson) DateTime get issueDate;@JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson) DateTime get dueDate; double get fixedCharge; double get tva; double get totalAmount; double get paidAmount; double get amountDue; String get invoiceStatus; DateTime get createdAt; DateTime get updatedAt; List<PaymentResponse> get payments;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,invoiceNumber,customerName,issueDate,dueDate,fixedCharge,tva,totalAmount,paidAmount,amountDue,invoiceStatus,createdAt,updatedAt,const DeepCollectionEquality().hash(payments));

@override
String toString() {
  return 'InvoiceResponse(id: $id, invoiceNumber: $invoiceNumber, customerName: $customerName, issueDate: $issueDate, dueDate: $dueDate, fixedCharge: $fixedCharge, tva: $tva, totalAmount: $totalAmount, paidAmount: $paidAmount, amountDue: $amountDue, invoiceStatus: $invoiceStatus, createdAt: $createdAt, updatedAt: $updatedAt, payments: $payments)';
}
...
/// Create a copy of InvoiceResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? invoiceNumber = null,Object? customerName = null,Object? issueDate = null,Object? dueDate = null,Object? fixedCharge = null,Object? tva = null,Object? totalAmount = null,Object? paidAmount = null,Object? amountDue = null,Object? invoiceStatus = null,Object? createdAt = null,Object? updatedAt = null,Object? payments = null,}) {
...
switch (_that) {
case _InvoiceResponse() when $default != null:
return $default(_that.id,_that.invoiceNumber,_that.customerName,_that.issueDate,_that.dueDate,_that.fixedCharge,_that.tva,_that.totalAmount,_that.paidAmount,_that.amountDue,_that.invoiceStatus,_that.createdAt,_that.updatedAt,_that.payments);case _:
  return orElse();
...
switch (_that) {
case _InvoiceResponse():
return $default(_that.id,_that.invoiceNumber,_that.customerName,_that.issueDate,_that.dueDate,_that.fixedCharge,_that.tva,_that.totalAmount,_that.paidAmount,_that.amountDue,_that.invoiceStatus,_that.createdAt,_that.updatedAt,_that.payments);}
}
...
class _InvoiceResponse implements InvoiceResponse {
  const _InvoiceResponse({required this.id, required this.invoiceNumber, required this.customerName, @JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson) required this.issueDate, @JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson) required this.dueDate, required this.fixedCharge, required this.tva, required this.totalAmount, required this.paidAmount, required this.amountDue, required this.invoiceStatus, required this.createdAt, required this.updatedAt, required final  List<PaymentResponse> payments}): _payments = payments;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,invoiceNumber,customerName,issueDate,dueDate,fixedCharge,tva,totalAmount,paidAmount,amountDue,invoiceStatus,createdAt,updatedAt,const DeepCollectionEquality().hash(_payments));
