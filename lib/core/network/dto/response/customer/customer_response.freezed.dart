...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,phone,address,customerType,plan,planValue,customerStatus,subscriptionDate,createdAt,customerRelation,hasPricingOverride,pricingOverride,totalBilled,totalPaid,totalOutstanding,paidThisMonth);

@override
String toString() {
  return 'CustomerResponse(id: $id, name: $name, phone: $phone, address: $address, customerType: $customerType, plan: $plan, planValue: $planValue, customerStatus: $customerStatus, subscriptionDate: $subscriptionDate, createdAt: $createdAt, customerRelation: $customerRelation, hasPricingOverride: $hasPricingOverride, pricingOverride: $pricingOverride, totalBilled: $totalBilled, totalPaid: $totalPaid, totalOutstanding: $totalOutstanding, paidThisMonth: $paidThisMonth)';
}
...
@useResult
$Res call({
 String id, String name, String? phone, String? address, String customerType, String plan, double planValue, String customerStatus,@JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson) DateTime subscriptionDate, DateTime createdAt, String? customerRelation, bool hasPricingOverride, CustomerPricingOverrideDto? pricingOverride, double totalBilled, double totalPaid, double totalOutstanding, bool paidThisMonth
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String? phone,  String? address,  String customerType,  String plan,  double planValue,  String customerStatus, @JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson)  DateTime subscriptionDate,  DateTime createdAt,  String? customerRelation,  bool hasPricingOverride,  CustomerPricingOverrideDto? pricingOverride,  double totalBilled,  double totalPaid,  double totalOutstanding,  bool paidThisMonth)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CustomerResponse() when $default != null:
return $default(_that.id,_that.name,_that.phone,_that.address,_that.customerType,_that.plan,_that.planValue,_that.customerStatus,_that.subscriptionDate,_that.createdAt,_that.customerRelation,_that.hasPricingOverride,_that.pricingOverride,_that.totalBilled,_that.totalPaid,_that.totalOutstanding,_that.paidThisMonth);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String? phone,  String? address,  String customerType,  String plan,  double planValue,  String customerStatus, @JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson)  DateTime subscriptionDate,  DateTime createdAt,  String? customerRelation,  bool hasPricingOverride,  CustomerPricingOverrideDto? pricingOverride,  double totalBilled,  double totalPaid,  double totalOutstanding,  bool paidThisMonth)  $default,) {final _that = this;
switch (_that) {
case _CustomerResponse():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String? phone,  String? address,  String customerType,  String plan,  double planValue,  String customerStatus, @JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson)  DateTime subscriptionDate,  DateTime createdAt,  String? customerRelation,  bool hasPricingOverride,  CustomerPricingOverrideDto? pricingOverride,  double totalBilled,  double totalPaid,  double totalOutstanding,  bool paidThisMonth)?  $default,) {final _that = this;
switch (_that) {
case _CustomerResponse() when $default != null:
return $default(_that.id,_that.name,_that.phone,_that.address,_that.customerType,_that.plan,_that.planValue,_that.customerStatus,_that.subscriptionDate,_that.createdAt,_that.customerRelation,_that.hasPricingOverride,_that.pricingOverride,_that.totalBilled,_that.totalPaid,_that.totalOutstanding,_that.paidThisMonth);case _:
  return null;
...
class _CustomerResponse implements CustomerResponse {
  const _CustomerResponse({required this.id, required this.name, this.phone, this.address, required this.customerType, required this.plan, required this.planValue, required this.customerStatus, @JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson) required this.subscriptionDate, required this.createdAt, this.customerRelation, required this.hasPricingOverride, this.pricingOverride, required this.totalBilled, required this.totalPaid, required this.totalOutstanding, required this.paidThisMonth});
