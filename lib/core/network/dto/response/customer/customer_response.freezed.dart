...
@useResult
$Res call({
 String id, String name, String? phone, String? address, String? building, String? floor, String? cableName, String? boxId, String? boxName, String? ampereScheduleId, String? ampereScheduleName, String customerType, String plan, double planValue, double? initialMeterReading, String? areaName, String customerStatus,@JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson) DateTime subscriptionDate, DateTime createdAt, String? customerRelation, bool hasPricingOverride, CustomerPricingOverrideDto? pricingOverride, double totalBilled, double totalPaid, double totalOutstanding
});
...
switch (_that) {
case _CustomerResponse() when $default != null:
return $default(_that.id,_that.name,_that.phone,_that.address,_that.building,_that.floor,_that.cableName,_that.boxId,_that.boxName,_that.ampereScheduleId,_that.ampereScheduleName,_that.customerType,_that.plan,_that.planValue,_that.initialMeterReading,_that.areaName,_that.customerStatus,_that.subscriptionDate,_that.createdAt,_that.customerRelation,_that.hasPricingOverride,_that.pricingOverride,_that.totalBilled,_that.totalPaid,_that.totalOutstanding);case _:
  return orElse();
...
class _CustomerResponse implements CustomerResponse {
  const _CustomerResponse({required this.id, required this.name, this.phone, this.address, this.building, this.floor, this.cableName, this.boxId, this.boxName, this.ampereScheduleId, this.ampereScheduleName, required this.customerType, required this.plan, required this.planValue, this.initialMeterReading, this.areaName, required this.customerStatus, @JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson) required this.subscriptionDate, required this.createdAt, this.customerRelation, required this.hasPricingOverride, this.pricingOverride, this.totalBilled = 0.0, this.totalPaid = 0.0, this.totalOutstanding = 0.0});
