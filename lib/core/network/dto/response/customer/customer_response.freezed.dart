...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,phone,address,customerType,plan,planValue,areaName,customerStatus,subscriptionDate,createdAt,customerRelation,hasPricingOverride,pricingOverride,totalBilled,totalPaid,totalOutstanding);
...
class _CustomerResponse implements CustomerResponse {
  const _CustomerResponse({required this.id, required this.name, this.phone, this.address, required this.customerType, required this.plan, required this.planValue, this.areaName, required this.customerStatus, @JsonKey(toJson: _dateOnlyToJson, fromJson: _dateOnlyFromJson) required this.subscriptionDate, required this.createdAt, this.customerRelation, required this.hasPricingOverride, this.pricingOverride, this.totalBilled = 0.0, this.totalPaid = 0.0, this.totalOutstanding = 0.0});
