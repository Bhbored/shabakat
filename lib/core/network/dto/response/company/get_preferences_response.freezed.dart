...
switch (_that) {
case _GetPreferencesResponse():
return $default(_that.pricePerKilowat,_that.pricePerAmp,_that.fixedCharge,_that.tva,_that.residentialPricePerAmp,_that.residentialPricePerKilowat,_that.residentialFixedCharge,_that.residentialTVA,_that.commercialPricePerAmp,_that.commercialPricePerKilowat,_that.commercialFixedCharge,_that.commercialTVA,_that.industrialPricePerAmp,_that.industrialPricePerKilowat,_that.industrialFixedCharge,_that.industrialTVA,_that.language,_that.triggerDate,_that.triggerMessage);}
}
...
class _GetPreferencesResponse implements GetPreferencesResponse {
  const _GetPreferencesResponse({this.pricePerKilowat = 0, this.pricePerAmp = 0, this.fixedCharge = 0, this.tva = 11, this.residentialPricePerAmp = 0, this.residentialPricePerKilowat = 0, this.residentialFixedCharge = 0, this.residentialTVA = 11, this.commercialPricePerAmp = 0, this.commercialPricePerKilowat = 0, this.commercialFixedCharge = 0, this.commercialTVA = 11, this.industrialPricePerAmp = 0, this.industrialPricePerKilowat = 0, this.industrialFixedCharge = 0, this.industrialTVA = 11, this.language = 'en', this.triggerDate = 1, this.triggerMessage});
