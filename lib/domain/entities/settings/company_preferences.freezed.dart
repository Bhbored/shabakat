...
class _CompanyPreferences implements CompanyPreferences {
  const _CompanyPreferences({this.pricePerKilowat = 0, this.pricePerAmp = 0, this.fixedCharge = 0, this.tva = 11, this.residentialPricePerAmp = 0, this.residentialPricePerKilowat = 0, this.residentialFixedCharge = 0, this.residentialTVA = 11, this.commercialPricePerAmp = 0, this.commercialPricePerKilowat = 0, this.commercialFixedCharge = 0, this.commercialTVA = 11, this.industrialPricePerAmp = 0, this.industrialPricePerKilowat = 0, this.industrialFixedCharge = 0, this.industrialTVA = 11, this.language = 'en', this.triggerDate = 1, this.triggerMessage});
