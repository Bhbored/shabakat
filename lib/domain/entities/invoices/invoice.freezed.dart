...
mixin _$Invoice {
 ...
 String get id; DateTime get createdAt; DateTime get updatedAt; String get companyId; String get customerId; String? get customerName; String? get customerPhone; int get invoiceNumber; DateTime get issueDate; DateTime get dueDate; double get fixedCharge; double get tva; double get totalAmount; double get paidAmount; double get amountDue; double? get billedConsumption; InvoiceStatus get invoiceStatus; List<Payment>? get payments;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,createdAt,updatedAt,companyId,customerId,customerName,customerPhone,invoiceNumber,issueDate,dueDate,fixedCharge,tva,totalAmount,paidAmount,amountDue,billedConsumption,invoiceStatus,const DeepCollectionEquality().hash(payments));

@override
String toString() {
  return 'Invoice(id: $id, createdAt: $createdAt, updatedAt: $updatedAt, companyId: $companyId, customerId: $customerId, customerName: $customerName, customerPhone: $customerPhone, invoiceNumber: $invoiceNumber, issueDate: $issueDate, dueDate: $dueDate, fixedCharge: $fixedCharge, tva: $tva, totalAmount: $totalAmount, paidAmount: $paidAmount, amountDue: $amountDue, billedConsumption: $billedConsumption, invoiceStatus: $invoiceStatus, payments: $payments)';
}
...
class _Invoice implements Invoice {
  const _Invoice({required this.id, required this.createdAt, required this.updatedAt, required this.companyId, required this.customerId, this.customerName, this.customerPhone, required this.invoiceNumber, required this.issueDate, required this.dueDate, required this.fixedCharge, required this.tva, required this.totalAmount, required this.paidAmount, required this.amountDue, this.billedConsumption, this.invoiceStatus = InvoiceStatus.unpaid, final  List<Payment>? payments}): _payments = payments;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,createdAt,updatedAt,companyId,customerId,customerName,customerPhone,invoiceNumber,issueDate,dueDate,fixedCharge,tva,totalAmount,paidAmount,amountDue,billedConsumption,invoiceStatus,const DeepCollectionEquality().hash(_payments));
