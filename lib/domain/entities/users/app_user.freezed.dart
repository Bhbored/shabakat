...
@override
String toString() {
  return 'AppUser(id: $id, email: $email, phoneNumber: $phoneNumber, isBanned: $isBanned, companyName: $companyName, logoUrl: $logoUrl)';
}
...
class _AppUser implements AppUser {
  const _AppUser({required this.id, this.email, this.phoneNumber, this.isBanned = false, required this.companyName, this.logoUrl});
