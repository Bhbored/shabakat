...
mixin _$OtherExpenses {
 ...
 String get id; DateTime get createdAt; DateTime get updatedAt; String get companyId; String get expenseId; double get amount; String get type; String? get description;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,createdAt,updatedAt,companyId,expenseId,amount,type,description);

@override
String toString() {
  return 'OtherExpenses(id: $id, createdAt: $createdAt, updatedAt: $updatedAt, companyId: $companyId, expenseId: $expenseId, amount: $amount, type: $type, description: $description)';
}
...
@useResult
$Res call({
 String id, DateTime createdAt, DateTime updatedAt, String companyId, String expenseId, double amount, String type, String? description
});
...
/// Create a copy of OtherExpenses
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? createdAt = null,Object? updatedAt = null,Object? companyId = null,Object? expenseId = null,Object? amount = null,Object? type = null,Object? description = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  DateTime createdAt,  DateTime updatedAt,  String companyId,  String expenseId,  double amount,  String type,  String? description)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OtherExpenses() when $default != null:
return $default(_that.id,_that.createdAt,_that.updatedAt,_that.companyId,_that.expenseId,_that.amount,_that.type,_that.description);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  DateTime createdAt,  DateTime updatedAt,  String companyId,  String expenseId,  double amount,  String type,  String? description)  $default,) {final _that = this;
switch (_that) {
case _OtherExpenses():
return $default(_that.id,_that.createdAt,_that.updatedAt,_that.companyId,_that.expenseId,_that.amount,_that.type,_that.description);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  DateTime createdAt,  DateTime updatedAt,  String companyId,  String expenseId,  double amount,  String type,  String? description)?  $default,) {final _that = this;
switch (_that) {
case _OtherExpenses() when $default != null:
return $default(_that.id,_that.createdAt,_that.updatedAt,_that.companyId,_that.expenseId,_that.amount,_that.type,_that.description);case _:
  return null;
...
class _OtherExpenses implements OtherExpenses {
  const _OtherExpenses({required this.id, required this.createdAt, required this.updatedAt, required this.companyId, required this.expenseId, required this.amount, required this.type, this.description});
...
/// Create a copy of OtherExpenses
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? createdAt = null,Object? updatedAt = null,Object? companyId = null,Object? expenseId = null,Object? amount = null,Object? type = null,Object? description = freezed,}) {
