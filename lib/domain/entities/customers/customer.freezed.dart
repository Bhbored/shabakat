...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,createdAt,updatedAt,companyId,name,phone,address,areaName,areaId,customerType,customerRelation,subscriptionDate,priceOverride,fixedChargeOverride,tvaOverride,customerStatus,plan,planValue,const DeepCollectionEquality().hash(invoices)]);

@override
String toString() {
  return 'Customer(id: $id, createdAt: $createdAt, updatedAt: $updatedAt, companyId: $companyId, name: $name, phone: $phone, address: $address, areaName: $areaName, areaId: $areaId, customerType: $customerType, customerRelation: $customerRelation, subscriptionDate: $subscriptionDate, priceOverride: $priceOverride, fixedChargeOverride: $fixedChargeOverride, tvaOverride: $tvaOverride, customerStatus: $customerStatus, plan: $plan, planValue: $planValue, invoices: $invoices)';
}
...
@useResult
$Res call({
 String id, DateTime createdAt, DateTime updatedAt, String companyId, String name, String? phone, String? address, String? areaName, String? areaId, CustomerType customerType, CustomerRelation? customerRelation, DateTime subscriptionDate, double? priceOverride, double? fixedChargeOverride, double? tvaOverride, CustomerStatus customerStatus, PlanType plan, double planValue, List<Invoice>? invoices
});
...
switch (_that) {
case _Customer() when $default != null:
return $default(_that.id,_that.createdAt,_that.updatedAt,_that.companyId,_that.name,_that.phone,_that.address,_that.areaName,_that.areaId,_that.customerType,_that.customerRelation,_that.subscriptionDate,_that.priceOverride,_that.fixedChargeOverride,_that.tvaOverride,_that.customerStatus,_that.plan,_that.planValue,_that.invoices);case _:
  return orElse();
...
class _Customer implements Customer {
  const _Customer({required this.id, required this.createdAt, required this.updatedAt, required this.companyId, required this.name, this.phone, this.address, this.areaName, this.areaId, required this.customerType, this.customerRelation, required this.subscriptionDate, this.priceOverride, this.fixedChargeOverride, this.tvaOverride, this.customerStatus = CustomerStatus.active, required this.plan, required this.planValue, final  List<Invoice>? invoices}): _invoices = invoices;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,createdAt,updatedAt,companyId,name,phone,address,areaName,areaId,customerType,customerRelation,subscriptionDate,priceOverride,fixedChargeOverride,tvaOverride,customerStatus,plan,planValue,const DeepCollectionEquality().hash(_invoices)]);
